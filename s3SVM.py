...
with open('all_gestures_plain.csv', 'rb') as csvfile:
...
splits=[0, 0.13, 0.24, 0.35, 0.5, 0.7, 1, 1.75, 3.3, 5, 10]
probs = []
logs = []
scores = []
...
pylab.scatter(probs[:-85],logs[:-85], s=3, color='blue')
pylab.scatter(probs[-85:],logs[-85:], s=3, color='red')
pylab.show()

with open('s3svm_scores.csv', 'wb') as csvfile:
